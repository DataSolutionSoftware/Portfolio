...
As Technical Authority for the UK MoD’s StrikeNet project, I architected a defence-grade digital twin that virtualized combat systems, integrating real-time analytics and AI to enhance mission readiness. The solution reduced operational risks by 30% while improving asset reliability—proving its value in high-stakes environments where cost efficiency and system resilience are critical.

By leveraging this technology, it optimises asset management and strengthens mission readiness.
